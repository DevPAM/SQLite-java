...
public abstract class DataBase extends SQLite {
    ...
    public DataBase(String path_folder, String database_name) throws SQLiteArgumentNullException, SQLiteFolderNotExists, SQLException {
    ...
    protected abstract void createTables() throws SQLException, SQLiteArgumentNullException;
}
